...
fwrite(data.frame(row=i.all,eid=diseases$eid[i.all]),'/athena/elementolab/scratch/anm2868/vQTL/UKB/blood_disease.indiv_id.txt',col.names = T,row.names = F,quote=F,sep = '\t',na='NA')
